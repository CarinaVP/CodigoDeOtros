...
public class Ejercicio4 {
	...
	public static void main(String[] args) {
	 ...
	 // Declaro el objeto e inicializ con el objeto de entrada estándar.
	 // tengo en cuenta que se necesita introducir un parámetro que indique de dónde procederán la fuente de datos. 
